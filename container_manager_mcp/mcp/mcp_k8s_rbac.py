...
def register_k8srbac_tools(mcp: FastMCP):
    ...
    async def cm_k8s_rbac(
        ...
        name: str | None = Field(default=None, description="Resource name for advanced RBAC operations"),
        spec: dict | None = Field(default=None, description="Specification for advanced RBAC operations"),
        ...
        sa_name: str | None = Field(default=None, description="ServiceAccount name for secret mapping"),
        ...
        try:
            ...
            if action == "list_roles":
                ...
                return await run_blocking(manager.delete_cluster_rolebinding, name=rolebinding_name)
            ...
            # ServiceAccount token management
                ...
                return await run_blocking(manager.delete_service_account_token, name, ns, token_name)
            ...
            # Aggregated cluster roles
                ...
                return await run_blocking(manager.create_aggregated_cluster_role, name, aggregation_rule)
                ...
                return await run_blocking(manager.update_aggregated_cluster_role, name, aggregation_rule)
            ...
            # ServiceAccount-secret mapping
                ...
                return await run_blocking(manager.map_secret_to_service_account, secret_name, sa_name, ns)
                ...
                return await run_blocking(manager.unmap_secret_from_service_account, secret_name, sa_name, ns)
