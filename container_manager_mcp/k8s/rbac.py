...
class RbacMixin:
    ...
    def create_role(
        ...
        try:
            ...
            role = _km.k8s_client.V1Role(
                metadata=_km.k8s_client.V1ObjectMeta(name=name), rules=role_rules or None
            )
    ...
    def subject_access_review(self, spec: dict) -> dict:
        ...
        try:
            auth_api = self.authz
            sar = _km.k8s_client.V1SubjectAccessReview(spec=_km.k8s_client.V1SubjectAccessReviewSpec(**spec))
    ...
    def update_aggregated_cluster_role(self, name: str, aggregation_rule: dict) -> dict:
        ...
        try:
            ...
            existing.aggregation_rule = _km.k8s_client.V1AggregationRule(**aggregation_rule)
