...
class InteropMixin:
    ...
    def podman_volume_create(self, volume_name: str, driver: str = "local") -> dict:
        ...
        try:
            result = {"volume_name": volume_name, "driver": driver, "status": "created"}
    ...
    def docker_swarm_join(
        ...
        try:
            result = {"remote_addr": remote_addr, "worker": worker, "status": "joined"}
    ...
    def docker_swarm_leave(self, force: bool = False) -> dict:
        ...
        params = {"force": force}
        try:
            result = {"force": force, "status": "left"}
    ...
    def docker_service_rm(self, service_name: str) -> dict:
        ...
        try:
            result = {"service_name": service_name, "status": "removed"}
    ...
    def docker_config_create(self, config_name: str, data: str) -> dict:
        ...
        try:
            result = {"config_name": config_name, "status": "created"}
    ...
    def docker_config_list(self) -> list[dict]:
        ...
        params: dict[str, Any] = {}
        try:
            result = [{"name": "simulated_config", "created": self._ts(None)}]
    ...
    def docker_secret_create(self, secret_name: str, data: str) -> dict:
        ...
        try:
            result = {"secret_name": secret_name, "status": "created"}
    ...
    def docker_secret_list(self) -> list[dict]:
        ...
        params: dict[str, Any] = {}
        try:
            result = [{"name": "simulated_secret", "created": self._ts(None)}]
    ...
    def docker_node_inspect(self, node_id: str) -> dict:
        ...
        try:
            result = {
                ...
                "availability": "Active",
                "manager_status": "Leader",
                "resources": {"cpus": 4, "memory": "16GB", "storage": "500GB"},
            }
