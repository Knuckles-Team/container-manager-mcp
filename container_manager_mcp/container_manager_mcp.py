...
def container_manager_mcp():
    parser = argparse.ArgumentParser(
        add_help=False, description="Container Manager MCP Server"
    )
    parser.add_argument(
        "-t",
        "--transport",
...
def usage():
    print(
        f"Container Manager Mcp ({__version__}): Container Manager MCP Server\n\n"
        "Usage:\n"
        ...
        "--required-scopes                  [ Comma-separated list of required scopes (e.g., containermanager.read,containermanager.write). ]\n"
