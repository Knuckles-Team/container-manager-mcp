...
# Paths
ROOT_DIR = "/home/apps/workspace/agent-packages/agents/container-manager-mcp"
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in container-manager-mcp
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in container-manager-mcp but are NOT registered "
