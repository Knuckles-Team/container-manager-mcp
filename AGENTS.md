...
# Execution Commands
# container-manager\ncontainer_manager_mcp.container_manager:container_manager\n# container-manager-mcp\ncontainer_manager_mcp.mcp:mcp_server\n# container-manager-agent\ncontainer_manager_mcp.agent:agent_server

## Project Structure Quick Reference
- MCP Entry Point → `mcp.py`
- Agent Entry Point → `agent.py`
- Source Code → `container_manager_mcp/`
